...
class AccountServiceTest {
    ...
    void createAccountSuccess(){
        ...
        BDDMockito.given(accountRepository.findFirstByOrderByIdDesc())
    ...
    void createAccount_maxAccountIs10(){
        ...
        BDDMockito.given(accountUserRepository.findById(anyLong()))
                .willReturn(Optional.of(user));
        BDDMockito.given(accountRepository.countByAccountUser(any()))
                .willReturn(10);
        //when
        AccountException exception = assertThrows(AccountException.class,
                () -> accountService.createAccount(1L,1000L));
    ...
    void successGetAccountsByUserId(){
        ...
        BDDMockito.given(accountUserRepository.findById(anyLong()))
                .willReturn(Optional.of(pobi));
        BDDMockito.given(accountRepository.findByAccountUser(any()))
                .willReturn(accounts);
        //when
